...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: BorrowingHistory::class, orphanRemoval: true)]
    ...
    public function removeBorrowingHistory(BorrowingHistory $borrowingHistory): static
    {
        if ($this->borrowingHistories->removeElement($borrowingHistory)) {
            ...
            if ($borrowingHistory->getUser() === $this) {
                $borrowingHistory->setUser(null);
            }
        }
